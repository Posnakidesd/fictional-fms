...
public class Heartbeat extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8785046621228883552L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Heartbeat\",\"namespace\":\"com.trg.fms.api\",\"fields\":[{\"name\":\"id\",\"type\":[\"null\",\"long\"]},{\"name\":\"type\",\"type\":{\"type\":\"enum\",\"name\":\"HeartbeatType\",\"symbols\":[\"TYPE60\",\"TYPE80\"]},\"order\":\"ignore\"},{\"name\":\"distance\",\"type\":[\"null\",\"long\"],\"order\":\"ignore\"}]}");
  ...
  public static Heartbeat fromByteBuffer(
   ...
   private com.trg.fms.api.HeartbeatType type;
   ...
   */
  public Heartbeat(java.lang.Long id, com.trg.fms.api.HeartbeatType type, java.lang.Long distance) {
    this.id = id;
    this.type = type;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: type = (com.trg.fms.api.HeartbeatType)value$; break;
    case 2: distance = (java.lang.Long)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.trg.fms.api.HeartbeatType getType() {
    return type;
  }
   ...
   * @param value the value to set.
   */
  public void setType(com.trg.fms.api.HeartbeatType value) {
    this.type = value;
  }
   ...
   */
  public static com.trg.fms.api.Heartbeat.Builder newBuilder() {
    return new com.trg.fms.api.Heartbeat.Builder();
  }
   ...
   * @return A new Heartbeat RecordBuilder
   */
  public static com.trg.fms.api.Heartbeat.Builder newBuilder(com.trg.fms.api.Heartbeat.Builder other) {
    if (other == null) {
      return new com.trg.fms.api.Heartbeat.Builder();
    } else {
      return new com.trg.fms.api.Heartbeat.Builder(other);
    }
  }
   ...
   * @return A new Heartbeat RecordBuilder
   */
  public static com.trg.fms.api.Heartbeat.Builder newBuilder(com.trg.fms.api.Heartbeat other) {
    if (other == null) {
      return new com.trg.fms.api.Heartbeat.Builder();
    } else {
      return new com.trg.fms.api.Heartbeat.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Heartbeat>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.trg.fms.api.Heartbeat.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.trg.fms.api.Heartbeat other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.trg.fms.api.Heartbeat.Builder setId(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.trg.fms.api.Heartbeat.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.trg.fms.api.Heartbeat.Builder setType(com.trg.fms.api.HeartbeatType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.trg.fms.api.Heartbeat.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.trg.fms.api.Heartbeat.Builder setDistance(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.trg.fms.api.Heartbeat.Builder clearDistance() {
      distance = null;
    ...
    public Heartbeat build() {
      try {
        ...
        record.type = fieldSetFlags()[1] ? this.type : (com.trg.fms.api.HeartbeatType) defaultValue(fields()[1]);
        record.distance = fieldSetFlags()[2] ? this.distance : (java.lang.Long) defaultValue(fields()[2]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.type = com.trg.fms.api.HeartbeatType.values()[in.readEnum()];
